...
class Item(models.Model):
    ls = models.ManyToManyField('LG', blank=True, related_name='item_lg')
    samsung_tv = models.ManyToManyField('Samsung_TV', blank=True, related_name='item_samsung_tv')
    sony = models.ManyToManyField('Sony', blank=True, related_name='item_sony')
    panasonic = models.ManyToManyField('Panasonic', blank=True, related_name='item_panasonic')
    samsung = models.ManyToManyField('Samsung', blank=True, related_name='item_samsung')
    apple = models.ManyToManyField('Apple', blank=True, related_name='item_apple')
    xiaomi = models.ManyToManyField('Xiaomi', blank=True, related_name='item_xiaomi')
    mac_os = models.ManyToManyField('Mac_OS', blank=True, related_name='item_mac_os')
    asus = models.ManyToManyField('ASUS', blank=True, related_name='item_asus')
    acer = models.ManyToManyField('ACER', blank=True, related_name='item_acer')
    slug = models.SlugField(unique=True, blank=True)
